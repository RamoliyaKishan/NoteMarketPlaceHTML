                                        ...
                                        if($db_Status == 'Draft')
                                        {
                                            echo "<td>
                                                    <span class='action-icons'>
                                                        <a href='add-notes.php'><img src='../images/Front_images/edit.png' alt='edit' class='edit-icon'></a>
                                                        <a href='dashboard.php?delete={$db_NoteID}'><img src='../images/Front_images/delete.png' alt='delete'></a>
                                                    </span>
                                                </td>";
                                        }else {
                                            echo "<td>
                    ...
                    <tbody>
                        <?php
                                    ...
                                    while($row = mysqli_fetch_assoc($select_all_notes_query )) {
                                        ...
                                        echo "<td>
                                                <span class='action-icons'>
                                                    <a href='dashboard.php?view={$db_NoteID}'><img src='../images/Front_images/eye.png' alt='view' class='view-icon'></a>
                                                </span>
                                            </td>";
