					...
					<div class="col-md-6 col-sm-12">
						<div class="user-profile-left">
								...
								<div class="form-group">
									...
									<input class="myInput" placeholder="Enter your First Name" type="text" id="first-name" value="<?php echo "$db_FirstName"; ?>" required>
								</div>

								<div class="form-group">
									<label class="form-label">Email *</label>
									<input class="myInput" placeholder="Enter your Email address" type="email" id="login-email" value="<?php echo "$db_EmailID"; ?>" required>
								</div>
					...
					<div class="col-md-6 col-sm-12">
						<div class="user-profile-right">
								<div class="form-group">
									...
									<input class="myInput" placeholder="Enter your Last Name" type="text" id="last-name" value="<?php echo "$db_LastName"; ?>" required>
								</div>
								...
								<div class="form-group">
									...
									<div>
										<select class="myInput country-code" name="country_code" id="country_code">
											<option class="option" value="" disabled selected>Select country code</option>
											<option class="option" value="+91" <?php if($country_code=="+91") echo 'selected="selected"'; ?> >+91</option>
											<option class="option" value="+92" <?php if($country_code=="+92") echo 'selected="selected"'; ?> >+92</option>
											<option class="option" value="2" <?php if($country_code=="+1") echo 'selected="selected"'; ?> >+1</option>
											<option class="option" value="+44" <?php if($country_code=="+44") echo 'selected="selected"'; ?> >+44</option>
											<option class="option" value="+324" <?php if($country_code=="+324") echo 'selected="selected"'; ?> >+324</option>
											<option class="option" value="+261" <?php if($country_code=="+261") echo 'selected="selected"'; ?> >+261</option>
										</select>

										<input class="myInput phone-no" maxlength="21" type="phone" id="phone_number" name="phone_number" placeholder="enter your phone number" value="<?php echo $phone_number; ?>" required>
									</div>
								</div>
						</div>
					</div>
