                        ...
                        <?php
                            ...
                            if(isset($_POST['download-btn'])){
                                if(isset($_SESSION['UsersID'])) {
                                    ...
                                    $query = "SELECT FirstName, EmailID FROM users WHERE UsersID = '{$downloader_id}'";
                                    ...
                                    if(mysqli_num_rows($check_request) <= 0) {
                                        ...
                                        if($download_note_query){
                                            ...
                                            $subject    = $buyer_name . " wants to purchase your notes.";

                                            $message      = "\r\n" . "Hello " . $seller_name . ", " . "\r\n" . "\r\n";
                                            
                                            $message      .= "We would like to inform you that, " .$buyer_name . " wants to purchase your " . $db_Title . " notes. Please see Buyer Requests tab and allow download access to Buyer if you have received the payment from him." . "\r\n" . "\r\n";
                                            $message      .= "Regards, " . "\r\n" . "Notes Marketplace";
